...
import type { RiderDatePreset, RiderDateRange } from "../hooks/useRiderHistory";

interface RiderHistoryFiltersProps {
    datePreset: RiderDatePreset;
    dateRange: RiderDateRange;
    isFiltered: boolean;
    setDatePreset: (preset: RiderDatePreset) => void;
    setDateRange: (range: RiderDateRange) => void;
    resetFilters: () => void;
}

const DATE_PRESETS: { label: string; value: RiderDatePreset }[] = [
    { label: "Today", value: "today" },
    { label: "This Week", value: "this_week" },
    { label: "This Month", value: "this_month" },
];

export function RiderHistoryFilters({
    datePreset,
    dateRange,
    isFiltered,
    setDatePreset,
